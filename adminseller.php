                    ...
                    <div class="brand-wrapper">
                        <center>
                            ...
                            <h4>
                                ...
                                if ($result = $link->query("SELECT * FROM seller"))
                                {
                                // display records if there are records to display
                                if ($result->num_rows > 0)
                                {
                                // display records in a table
                                echo "<table border='1' width='99%' id='tebel' cellpadding='10'>";

                                // set table headers
                                echo "<tr><th width='100px'>ID Peniaga</th><th width='100px'>ID Kedai</th><th width='170px'>Nama Peniaga</th><th width='170px'>Nama Kedai</th><th width='170px'>Gambar Seller</th></tr>";
                                ...
                                echo strtoupper ("<td>" . $row->sellerpic . "</td>");
                                echo "</tr>";
                                }

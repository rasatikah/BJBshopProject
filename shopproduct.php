    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.php">e<span>Let'sShop</span></a></h1>
                    </div>
                </div>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td style='padding:10px'>
                                        <img src='".$row['productImage']."' height='550' width='600'/>
                                    </td>
                                    <td style='padding:10px' valign='top' align='left'>
                                        <h1><a href='shopproduct.php?productID=".$row['productID']."&productName=".$row['productName']."'><div class='productName'>".$row['productName']."</div></a></h1>
                                        <h3><div class='productPrice'>RM".$row['productPrice']."</div></h3>
                                        <h4><a href='shopcategory.php?category=".$row['productCategories']."'>".$row['productCategories']."</a></h4>
                                        <p><div class='productPrice'>".$row['productDetail']."</div></p><br><br>

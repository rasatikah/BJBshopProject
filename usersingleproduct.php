                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style='padding:10px' valign='top' align='left'>
                                        <h1><a href='usersingleproduct.php?productID=".$row['productID']."&productName=".$row['productName']."'><div class='productName'>".$row['productName']."</div></a></h1>
                                        <h3><div class='productPrice'>RM".$row['productPrice']."</div></h3>
                                        <h4><a href='usercategory2.php?category=".$row['productCategories']."'>".$row['productCategories']."</a></h4>

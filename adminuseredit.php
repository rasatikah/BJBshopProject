...
<html>
   <head>
    ...
    <!--  <style>
        body{
          background: url(photo/johorflag.jpg) no-repeat center center fixed; 
...
<section class="page-content">
  <section class="search-and-user">
    <form>
      ...
      <div class="header">
  <h1> BJStore | Kemaskini Maklumat Pengguna</h1>
  <p></p>
</div>
 ...
 <h1><?php if ($userID != '') { echo " "; } else { echo "New Record"; } ?></h1>
        <?php if ($error != '') {
      ...
      <form action="" method="post">
        <div>
          ...
          <p><b>ID Pengguna: </b> <?php echo $userID; ?></p>
          <?php } ?>
            <div>
              ...
              <p>Sila isi kotak bertanda (*) </p> <br>
              <input  type="submit" name="submit" value="KEMASKINI" /> <br> <br>
            
             

          <button type="submit" name="submit" onclick="window.location.href='adminuser.php'">KEMBALI KE LAMAN URUS PENGGUNA</button>

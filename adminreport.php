<?php 
    ...
    $query = "SELECT sellerpart.sellerID, sellerpart.month, sellerpart.sales 
    FROM sellerpart, seller 
    WHERE sellerpart.sellerID = seller.sellerID 
    ORDER BY sellerpart.sellerID";
...
<table  class="shop_table cart">
  <thead>
    ...
    <tr>
        <td>1</td>
        <td>ABC Shop</td>
        <td><a href="adminyear.php"> See reports</td>

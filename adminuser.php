    ...
    <div class="brand-wrapper">
                        ...
                        <center>
                            ...
                            <h4>
                                ...
                                echo "<table border='2' width='99%' id='tebel' cellpadding='12'>";

                                // set table headers
                                echo "<tr><th width='80px'>ID Pengguna</th><th width='150px'>Nama</th><th width='170px'>Nombor Telefon</th><th>Alamat Email</th><th width='280px'>Alamat Rumah</th><th width='120px'>Tindakan</th></tr>";

                                while ($row = $result->fetch_object())
                                {
                                // set up a row for each record
                                echo "<tr cellpadding='12'>";
                                echo strtoupper ("<td>" . $row->userID . "</td>");
                                echo strtoupper ("<td>" . $row->custName . "</td>");
                                echo strtoupper ("<td>" . $row->phoneNumber . "</td>");
                                echo lcfirst ("<td>" . $row->email . "</td>");
                                echo strtoupper ("<td>" . $row->custAddress ."</td>");
                                echo "<td> <a href='adminuseredit.php?userID=" . $row->userID . "'>Kemaskini</a> </td>";
                                echo "</tr>";
                                }
                        ...
                        <h4>AMARAN: Tindakan anda tidak akan dapat diulangi semula!</h4> <br>
                        <b>Sila masukkan ID Pengguna yang ingin dipadamkan</b>
                        <br><br>

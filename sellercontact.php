                    ...
                    <br><br><br>
						...
						<center>
								<div class="column">
									...
									<h4>
										Address Jalan Pulai Harmoni 3, <br>
							...
							<div class="column" style="background-color:rgb(144, 106, 179);">
								<div>
									<form action="">
										<b>
											<h4>Name:</h4> <input type="text" name="contactName" size="50"><br><br>
                                            <h4>Email:</h4> <input type="email" name="contactEmail" size="50"><br><br>
                                            <h4>Phone Number:</h4> <input type="number" name="contactPhoneNumber" size="53"><br><br>
                                            <h4>Messages:</h4> <textarea type="textarea" name="contactEnquiry" rows="10" cols="70"></textarea><br><br>
										</b>								
											<input name="submit" onclick="alert('Submitted. Thank you!')" type="submit" value="Submit">
											<div></div>
									</form>
								<p></p>
							</div>

            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="adminseller.php">Urus Perniaga</a></li>
                        ...
                        <center>
                            ...
                            <h4>
                                ...
                                <table border="1" width="50%" id="tebel" >
                                    <tr>
                                        <th colspan="2" align="center" id="th1">Maklumat Peribadi</th>
                                    </tr>
                                    <tr>
                                        <td>Nama:</td>
                                        <td>Ras Atikah Binti Mohd Ridzuan</td>
                                    ...
                                    <tr>
                                        <td>Nama Syarikat:</td>
                                        <td>Berjaya Time Square Sdn. Bhd.</td>
                                    </tr>
                                    <tr>
                                        <td>Akaun Bank</td>
                                        <td>CIMB bank</td>
                                ...
                                <table border="1" width="50%" id="tebel">
                                    <tr>
                                        <th colspan="2" align="center" id="th1">Alamat</th>
                                    </tr>

                                    <!--Billing Address-->
                                    <tr>
                                        <td rowspan="6" >Alamat Bil</td>
                                    ...
                                    <!--Shipping Address-->
                                    <tr>
                                        <td rowspan="6">Alamat penghataran</td>
                                    </tr>
                                    <tr>
                                        <td>U6A 406</td> <!--Line 1-->
                                    </tr>

   ...
   <center>
    ...
    <div class="content">
                            ...
                            <?php  if (isset($_SESSION['username'])) : ?>
                                <h1>  <br><br> &nbsp;&nbsp; &nbsp;&nbsp;Selamat Datang,  <strong><?php echo $_SESSION['username']; ?></strong></h1>
                            <?php endif ?>
                                <h3>
...
<div class="wrapper">
  ...
  <footer class="page-footer">
    <small> <span>❤</span> by <a href="http://georgemartsoukos.com/" target="_blank"></a>
    </small>
  </footer>
</section>

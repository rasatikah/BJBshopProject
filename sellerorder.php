            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="sellerorder.php">Urus Pembayaran</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        <!------------------------------------------------------------------------->
                        <h2 class="sidebar-title">Lihat Pembayaran</h2>
                        ...
                        <table  class="shop_table cart">
                            ...
                            <th  width="20%">Resit Pembayaran</th>
                            <th width="20%">Nama Pembayar</th>
                            <th width="10%">Kata Nama Pembayar</th>
                            <th width="5%">Jumlah Pesanan (RM)</th>
                            <th width="20%">Waktu Pembayaran</th>
                            <th width="20%">Lihat Pesanan </th>
                            </tr>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="<?php echo $proofPayment ?>" alt="" onclick="window.open(this.src)"></td>
                                    <td><?php echo $custName ?></td>
                                    <td><?php echo $username ?></td>
                                    <td><?php echo $price ?></td>
                                    <td><?php echo $paymentTime ?></td>
                                    <td><a href="sellerorder3.php?paymentID=<?php echo $paymentID ?>">Klik Sini</a></td>
                                </tr>
                            <?php
                                }
                            ?>

...
<div class="header-area">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2><?php echo 'Kategori '.$category?></h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form  method="GET" action="usercategory2.php?category=">
            <ul class="breadcrumb">
                ...
                <li><?php echo 'Kategori '.$category?></li>
            </ul>
        <center>
	...
	<div style="width:100%; margin:50 auto;">
        ...
        $category = $_GET['category'];
		$result = mysqli_query($con,"SELECT * FROM `product` where productCategories = '". $category ."'");
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2015 eLet'sShop. All Rights Reserved. Coded with <i class="fa fa-heart"></i> by <a href="http://wpexpand.com" target="_blank">WP Expand</a></p>
                    </div>
                </div>

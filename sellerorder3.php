...
.avatar {
  ...
  <body>
    ...
    <ul class="breadcrumb">
                ...
                <li><a href="sellerorder.php">Pembayaran</a></li>
                <li>Pesanan bagi ID Pembayaran <?php echo $orderID?></li>
            </ul>
                ...
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        ...
                        <?php
                            ...
                            echo "<h2>Sedang melihat Pesanan bagi ID Pembayaran ". $orderID ."</h2>";

                        ?>
                        <button onclick="location.href = 'sellerorder.php';">Kembali</button><br><br><br>
                        ...
                        <table  class="shop_table cart">
                            ...
                            <?php
                                ...
                                $con = mysqli_connect("localhost","root","", "projectwd");
                                $query = "SELECT * from paymenting where paymentID = '". $paymentID ."' ";
                                $result = mysqli_query($con, $query);

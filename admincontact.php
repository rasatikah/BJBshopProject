                    ...
                    <div class="brand-wrapper">
                        ...
                        <center>
                            ...
                            <h4>
                                ...
                                if ($result = $link->query("SELECT * FROM contact"))
                                {
                                ...
                                // set table headers
                                echo "<tr><th width='100px'>ID Mesej</th><th width='170px'>Nama</th><th width='170px'>Nombor Telefon</th><th width='170px'>Alamat Email</th><th width='60px'>Tindakan</th></tr>";

                                while ($row = $result->fetch_object())
                                {
                                // set up a row for each record
                                echo "<tr>";
                                echo strtoupper ("<td>" . $row->contactID . "</td>");
                                echo strtoupper ("<td>" . $row->name . "</td>");
                                echo strtoupper ("<td>" . $row->phoneNumber . "</td>");
                                echo strtoupper ("<td>" . $row->email ."</td>");
                                echo "<td> <a href='admincontactview.php?contactID=" . $row->contactID . "'>Lihat Mesej</a></td>";
                                echo "</tr>";
                                }

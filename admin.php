                    ...
                    <div class="brand-wrapper">
                        <center>
                            ...
                            <h4>
                                ...
                                if ($result = $link->query("SELECT * FROM admin WHERE username = '".$_SESSION['username'] ."'"))
                                {
                                ...
                                // set table headers
                                echo "<tr><th width='100px'>ID Admin</th><th width='170px'>Nama</th><th width='170px'>Nombor Telefon</th></tr>";

                                while ($row = $result->fetch_object())
                                {
                                // set up a row for each record
                                echo "<tr>";
                                echo strtoupper ("<td>" . $row->adminID . "</td>");
                                echo strtoupper ("<td>" . $row->adminName . "</td>");

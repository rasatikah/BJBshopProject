...
if(isset($_POST['update']))
{
    ...
    $query = "update product set  productName = '".$productname."', productPrice = '".$productprice."', productQuantity = '".$productquantity."', productDetail = '".$productdetail."', productCategories = '".$productCategories."' where productID ='".$productid."'";
